<template>
  <div class="bg-fixed h-full flex flex-row justify-center items-center object-cover"
       style="background-image: url(https://minio.egosnet.click/social-network/EGOSNET.svg); background-position-x: center;">
